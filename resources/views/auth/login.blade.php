...
<div class="container login">
    <div class="row heading wow fadeInUp" data-wow-duration="1000ms" data-wow-delay="300ms">
                    ...
                    <form class="form-horizontal" role="form" method="POST" action="{{ url('/login') }}">
                        ...
                        <div class="form-group">
                            <div class="col-md-6 col-md-offset-4">
                                ...
                                <a class="btn btn-link" href="{{ url('/reminder') }}">رمز عبور خود را فراموش کرده اید؟</a>
                            </div>
                        </div>
                    </form>
                </div>

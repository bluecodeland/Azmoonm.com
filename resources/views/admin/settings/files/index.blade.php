            ...
            <div class="panel panel-default">
                <div class="table-responsive">
                    <table class="table table-striped">
                        ...
                        <tbody>
                        @foreach($file_options as $item)
                            <tr>
                                <td>{{ $item->label }}</td>
                                <td>{{ $item->value }}</td>
                                <td>
                                    <a href="{{ url('/admin/settings/files/' . $item->id . '/edit') }}" title="ویرایش"><button class="btn btn-primary btn-xs"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> ویرایش</button></a>
                                </td>
                            </tr>
                        @endforeach
                        </tbody>
